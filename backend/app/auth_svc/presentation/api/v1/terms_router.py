...
from app.auth_svc.application.use_cases.terms.agree_terms import AgreementInput, AgreeTermsUseCase
...
from app.auth_svc.presentation.schemas.terms_schema import (
    AgreeTermsRequest,
    TermResponse,
)
