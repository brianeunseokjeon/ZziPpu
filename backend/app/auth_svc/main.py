...
from app.auth_svc.infrastructure.persistence.database import AsyncSessionFactory, engine
from app.auth_svc.infrastructure.persistence.models.base import Base
from app.auth_svc.infrastructure.persistence.models import (  # noqa: F401 — register models
    EmailOtpModel,
    TermModel,
    TermsAgreementModel,
    UserModel,
...
from app.auth_svc.presentation.api.v1.router import v1_router
from app.auth_svc.presentation.middleware.error_handler import ErrorHandlerMiddleware
