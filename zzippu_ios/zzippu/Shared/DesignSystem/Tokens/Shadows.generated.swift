...
enum PrimitiveShadow {
    ...
    static let shadowSm = DSShadowStyle(color: .black.opacity(0.05), radius: 1, x: 0, y: 1)
    static let shadowMd = DSShadowStyle(color: .black.opacity(0.08), radius: 3, x: 0, y: 4)
    static let shadowLg = DSShadowStyle(color: .black.opacity(0.1), radius: 7.5, x: 0, y: 10)
