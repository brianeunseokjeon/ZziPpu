...
struct SemanticColorTokens {
    ...
    let quickButtonFormulaActiveBg: DynamicColor = DynamicColor(light: Color(hex: 0xDBEAFE), dark: Color(hex: 0x3B82F6, opacity: 0.28))
    let quickButtonFormulaActiveBorder: DynamicColor = DynamicColor(light: Color(hex: 0x93C5FD), dark: Color(hex: 0x60A5FA))
    let quickButtonFormulaActiveText: DynamicColor = DynamicColor(light: Color(hex: 0x1E40AF), dark: Color(hex: 0x93C5FD))
    let quickButtonBreastIdleBg: DynamicColor = DynamicColor(light: Color(hex: 0xFDF2F8), dark: Color(hex: 0xF472B6, opacity: 0.14))
    let quickButtonBreastIdleBorder: DynamicColor = DynamicColor(light: Color(hex: 0xFCE7F3), dark: Color(hex: 0xF472B6, opacity: 0.3))
    let quickButtonBreastIdleText: DynamicColor = DynamicColor(light: Color(hex: 0xBE185D), dark: Color(hex: 0xF472B6))
    let quickButtonBreastActiveBg: DynamicColor = DynamicColor(light: Color(hex: 0xFCE7F3), dark: Color(hex: 0xF472B6, opacity: 0.28))
    let quickButtonBreastActiveBorder: DynamicColor = DynamicColor(light: Color(hex: 0xF9A8D4), dark: Color(hex: 0xF472B6))
    let quickButtonBreastActiveText: DynamicColor = DynamicColor(light: Color(hex: 0x9D174D), dark: Color(hex: 0xF472B6))
    let quickButtonPeeIdleBg: DynamicColor = DynamicColor(light: Color(hex: 0xECFEFF), dark: Color(hex: 0x22D3EE, opacity: 0.14))
    let quickButtonPeeIdleBorder: DynamicColor = DynamicColor(light: Color(hex: 0xCFFAFE), dark: Color(hex: 0x22D3EE, opacity: 0.3))
    let quickButtonPeeIdleText: DynamicColor = DynamicColor(light: Color(hex: 0x0E7490), dark: Color(hex: 0x22D3EE))
    let quickButtonPeeActiveBg: DynamicColor = DynamicColor(light: Color(hex: 0xCFFAFE), dark: Color(hex: 0x22D3EE, opacity: 0.28))
    let quickButtonPeeActiveBorder: DynamicColor = DynamicColor(light: Color(hex: 0x67E8F9), dark: Color(hex: 0x22D3EE))
    let quickButtonPeeActiveText: DynamicColor = DynamicColor(light: Color(hex: 0x155E75), dark: Color(hex: 0x22D3EE))
    let quickButtonPooIdleBg: DynamicColor = DynamicColor(light: Color(hex: 0xFEFCE8), dark: Color(hex: 0xEAB308, opacity: 0.14))
    let quickButtonPooIdleBorder: DynamicColor = DynamicColor(light: Color(hex: 0xFEF9C3), dark: Color(hex: 0xEAB308, opacity: 0.3))
    let quickButtonPooIdleText: DynamicColor = DynamicColor(light: Color(hex: 0xA16207), dark: Color(hex: 0xFCD34D))
    let quickButtonPooActiveBg: DynamicColor = DynamicColor(light: Color(hex: 0xFEF9C3), dark: Color(hex: 0xEAB308, opacity: 0.28))
    let quickButtonPooActiveBorder: DynamicColor = DynamicColor(light: Color(hex: 0xFCD34D), dark: Color(hex: 0xEAB308))
    let quickButtonPooActiveText: DynamicColor = DynamicColor(light: Color(hex: 0x854D0E), dark: Color(hex: 0xFCD34D))
    let quickButtonSleepIdleBg: DynamicColor = DynamicColor(light: Color(hex: 0xFAF5FF), dark: Color(hex: 0xC084FC, opacity: 0.14))
    let quickButtonSleepIdleBorder: DynamicColor = DynamicColor(light: Color(hex: 0xF3E8FF), dark: Color(hex: 0xC084FC, opacity: 0.3))
    let quickButtonSleepIdleText: DynamicColor = DynamicColor(light: Color(hex: 0x7E22CE), dark: Color(hex: 0xC084FC))
    let quickButtonSleepActiveBg: DynamicColor = DynamicColor(light: Color(hex: 0xF3E8FF), dark: Color(hex: 0xC084FC, opacity: 0.28))
    let quickButtonSleepActiveBorder: DynamicColor = DynamicColor(light: Color(hex: 0xD8B4FE), dark: Color(hex: 0xC084FC))
    let quickButtonSleepActiveText: DynamicColor = DynamicColor(light: Color(hex: 0x6B21A8), dark: Color(hex: 0xC084FC))
    let quickButtonPlayIdleBg: DynamicColor = DynamicColor(light: Color(hex: 0xF0FDF4), dark: Color(hex: 0x4ADE80, opacity: 0.14))
    let quickButtonPlayIdleBorder: DynamicColor = DynamicColor(light: Color(hex: 0xDCFCE7), dark: Color(hex: 0x4ADE80, opacity: 0.3))
    let quickButtonPlayIdleText: DynamicColor = DynamicColor(light: Color(hex: 0x15803D), dark: Color(hex: 0x4ADE80))
    let quickButtonPlayActiveBg: DynamicColor = DynamicColor(light: Color(hex: 0xDCFCE7), dark: Color(hex: 0x4ADE80, opacity: 0.28))
    let quickButtonPlayActiveBorder: DynamicColor = DynamicColor(light: Color(hex: 0x86EFAC), dark: Color(hex: 0x4ADE80))
    let quickButtonPlayActiveText: DynamicColor = DynamicColor(light: Color(hex: 0x166534), dark: Color(hex: 0x4ADE80))
}
