#!/usr/bin/env ruby
# tools/add-dashboard-redesign-files-to-xcode.rb
# 대시보드 재설계(S3/S4)에서 추가된 신규 DS 컴포넌트 파일을 zzippu 타겟에 등록한다.
# Usage: ruby tools/add-dashboard-redesign-files-to-xcode.rb
