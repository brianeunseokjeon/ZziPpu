#!/usr/bin/env ruby
# tools/add-dashboard-swr-cache-files-to-xcode.rb
# 대시보드 SWR 디스크 캐시(스냅샷) 신규 Swift 파일을 zzippu 타겟에 등록.
# Usage: ruby tools/add-dashboard-swr-cache-files-to-xcode.rb
