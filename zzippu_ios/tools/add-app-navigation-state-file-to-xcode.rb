#!/usr/bin/env ruby
# tools/add-app-navigation-state-file-to-xcode.rb
# 성장 UI 발달탭 이동(IA 개편) 신규 Swift 파일을 zzippu 타겟에 등록.
# Usage: ruby tools/add-app-navigation-state-file-to-xcode.rb
