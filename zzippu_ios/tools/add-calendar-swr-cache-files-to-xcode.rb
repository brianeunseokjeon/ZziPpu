#!/usr/bin/env ruby
# tools/add-calendar-swr-cache-files-to-xcode.rb
# 달력 SWR 디스크 캐시(월별 스냅샷) 신규 Swift 파일을 zzippu 타겟에 등록.
# Usage: ruby tools/add-calendar-swr-cache-files-to-xcode.rb
