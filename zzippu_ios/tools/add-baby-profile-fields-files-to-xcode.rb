#!/usr/bin/env ruby
# tools/add-baby-profile-fields-files-to-xcode.rb
# 아기 프로필 신규 필드(혈액형) 관련 신규 Swift 파일을 zzippu 타겟에 등록.
# Usage: ruby tools/add-baby-profile-fields-files-to-xcode.rb
